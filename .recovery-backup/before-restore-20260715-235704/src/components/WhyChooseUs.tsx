          ...
          {features.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group relative rounded-2xl p-6 sm:p-8 bg-zinc-50 dark:bg-zinc-900/40 border border-zinc-100 dark:border-zinc-800/60 transition-colors duration-300 hover:bg-white dark:hover:bg-zinc-900 hover:border-emerald-500/20 dark:hover:border-emerald-400/20 hover:shadow-xl hover:shadow-emerald-500/2"
              >
