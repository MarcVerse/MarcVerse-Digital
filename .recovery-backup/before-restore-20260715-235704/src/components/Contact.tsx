      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <motion.div
            ...
            className="relative rounded-3xl p-6 sm:p-8 md:p-10 bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800/80 shadow-xl shadow-zinc-200/20 dark:shadow-none overflow-hidden"
          >
          ...
          <motion.div
            ...
            className="rounded-3xl p-6 sm:p-8 bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800/80 shadow-xl shadow-zinc-200/20 dark:shadow-none relative overflow-hidden"
          >
        ...
        >
          <div className="rounded-3xl p-6 sm:p-8 md:p-10 bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800/80 shadow-xl shadow-zinc-200/20 dark:shadow-none relative h-full flex flex-col justify-center">
