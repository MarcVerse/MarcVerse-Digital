...
const PortfolioCard: React.FC<PortfolioCardProps> = ({ project, variants, shouldReduceMotion }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden z-10">
        ...
        />
        <div className="absolute inset-0 bg-linear-to-t from-zinc-950/20 to-transparent pointer-events-none z-10" />
      ...
      <div className="p-6 md:p-8 flex flex-col justify-between grow z-10 relative">
        <div>
  ...
  return (
    <section id="featured-work" className="scroll-mt-18 md:scroll-mt-20">
      ...
      >
        ...
        <>
          <div className="absolute top-0 left-0 right-0 h-100 bg-linear-to-b from-slate-50 to-transparent dark:from-zinc-950/10 dark:to-transparent pointer-events-none" />
        ...
        >
          ...
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16 flex flex-col items-center gap-4">
            ...
            >
              Premium Digital <span className="text-transparent bg-clip-text bg-linear-to-r from-emerald-600 to-teal-500 dark:from-emerald-400 dark:to-teal-400 font-bold">Showcase</span>
            </h2>
          ...
          <div className="relative mx-auto max-w-4xl w-full flex flex-col items-center justify-center py-4 md:py-8 mb-16 md:mb-24">
            ...
            >
              ...
              <div className="absolute inset-0 bg-linear-to-t from-emerald-950/5 via-transparent to-zinc-950/5 pointer-events-none mix-blend-multiply" />
              <div className="absolute inset-0 bg-emerald-500/2 pointer-events-none mix-blend-color-burn" />
              <div className="absolute inset-0 bg-black/2 dark:bg-transparent pointer-events-none" />
