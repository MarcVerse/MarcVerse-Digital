    ...
    >
      ...
      <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16 flex flex-col items-center gap-4">
        ...
        <motion.div
          ...
          className="mt-16 md:mt-20 p-6 sm:p-8 md:p-10 rounded-3xl bg-zinc-50 dark:bg-zinc-900/40 border border-zinc-100 dark:border-zinc-800/60 text-center relative overflow-hidden"
        >
