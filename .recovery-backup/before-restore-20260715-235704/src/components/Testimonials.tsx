...
export default function Testimonials() {
  ...
  return (
    <Section
      ...
      backgrounds={
        <>
          <div className="absolute top-1/4 right-0 w-100 h-100 rounded-full bg-emerald-500/[0.03] blur-[100px] pointer-events-none" />
          <div className="absolute bottom-1/4 left-0 w-100 h-100 rounded-full bg-teal-500/[0.03] blur-[100px] pointer-events-none" />
        </>
      }
    >
      {/* Section Header */}
      <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16 flex flex-col items-center gap-4">
        ...
        >
          What Our <span className="text-transparent bg-clip-text bg-linear-to-r from-emerald-600 to-teal-500 dark:from-emerald-400 dark:to-teal-400">Clients Say</span>
        </h2>
          ...
          return (
            ...
            >
              ...
              <div className="relative z-10 flex items-center gap-4 border-t border-zinc-200/50 dark:border-zinc-800/50 pt-4">
                ...
                <div className={`flex items-center justify-center w-12 h-12 rounded-full bg-linear-to-br ${item.avatarBg} font-display text-sm font-bold shadow-sm flex-shrink-0`}>
                  {item.initials}
                </div>
