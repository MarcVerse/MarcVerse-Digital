...
export default function WhyChooseUs() {
  ...
  return (
    <Section
      id="why-choose-us"
      className="bg-white/5 dark:bg-zinc-900/20 backdrop-blur-sm"
      backgrounds={
    ...
    >
      ...
      <div className="text-center max-w-3xl mx-auto mb-8 md:mb-10 flex flex-col items-center gap-4">
          ...
          >
            Why Brands Partner With <span className="text-transparent bg-clip-text bg-linear-to-r from-emerald-600 to-teal-500 dark:from-emerald-400 dark:to-teal-400">MarcVerse</span>
          </h2>
          ...
          {features.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group relative rounded-2xl p-6 bg-zinc-50 dark:bg-zinc-900/40 border border-zinc-100 dark:border-zinc-800/60 transition-colors duration-300 hover:bg-white dark:hover:bg-zinc-900 hover:border-emerald-500/20 dark:hover:border-emerald-400/20 hover:shadow-xl hover:shadow-emerald-500/2"
              >
                ...
                {/* Icon wrapper */}
                <div className="mb-5 inline-flex items-center justify-center w-12 h-12 rounded-xl bg-white dark:bg-zinc-800 shadow-sm border border-zinc-100 dark:border-zinc-700/50 group-hover:border-emerald-500/20 group-hover:shadow-md group-hover:shadow-emerald-500/5 transition-all duration-300">
